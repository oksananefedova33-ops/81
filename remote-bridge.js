...
(function(){
    ...
    const API_TOKEN = 'c4e1df60c31d4280fcaed8e17367a0aafb7bac0fa730f24b2a7cc6a7d6d1372b'; // Будет заменено при экспорте
    const EDITOR_DOMAIN = 'gpt5-ai.pro'; // Домен редактора
